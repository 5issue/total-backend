...
/** 비즈니스 로직과 RabbitMQ 이벤트 발행의 원자성을 보장하기 위한 Transactional Outbox. */
@Entity
@Table(name = "wms_outbox")
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class WmsOutbox {
    ...
    @Builder
    private WmsOutbox(String eventId, String exchange, String routingKey, String typeId, String payload) {
