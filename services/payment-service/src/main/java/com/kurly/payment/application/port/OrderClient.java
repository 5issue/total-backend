...
public interface OrderClient {
     ...
     * 주문 스냅샷 조회.
     *
     * @throws com.kurly.payment.exception.OrderNotFoundException 주문이 없거나 만료된 경우
     */
     ...
     *
     * @param paidAt 승인 시각. 주문 서비스가 결제 완료 시점을 기록한다
     * @throws OrderAlreadyExpiredException 결제 유효시간(5분)이 지나 주문이 만료된 경우.
     *                                      호출부는 보상 취소를 수행해야 한다.
     */
    void completePayment(Long orderId, Long paymentId, long paymentAmount, LocalDateTime paidAt);
