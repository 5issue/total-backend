...
import com.kurly.product.application.OutboxPublishService;
...
public class OutboxPublishScheduler {
    ...
    @Scheduled(fixedDelayString = "${product.outbox.publish-delay-ms:5000}")
    public void publishOutbox() {
        try {
            outboxPublishService.publishPending(productOutboxProperties.batchSize());
